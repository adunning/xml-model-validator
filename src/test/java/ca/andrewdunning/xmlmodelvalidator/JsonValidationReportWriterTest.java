...
final class JsonValidationReportWriterTest {
    ...
    void serializesValidationReportWithStableFieldOrderAndNullLocations() {
        ...
        ValidationResult result = new ValidationResult(
                ...
                false,
                List.of(new ValidationIssue(Path.of("document.xml"), "Broken value", null, null, null, null, false)));

        String json = writer.write(List.of(result), 1, 1, 0, Duration.ofMillis(500));

        assertEquals("""
                                                {"summary":{"skipped":false,"filesChecked":1,"okFiles":0,"failedFiles":1,"warningCount":0,"elapsedSeconds":0.5},"results":[{"file":"document.xml","ok":false,"issues":[{"severity":"error","message":"Broken value","line":null,"column":null,"endLine":null,"endColumn":null}]}]}""", json);
    }
    ...
    void escapesJsonStringsInReportsAndPlans() {
        ...
        ValidationResult result = new ValidationResult(
                ...
                List.of(new ValidationIssue(
                        Path.of("folder", "doc\"name.xml"), "Broken slash \\ and \"quote\"", 3, 7, false)));
